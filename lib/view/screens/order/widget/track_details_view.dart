      ...
      child: (!_takeAway && track.deliveryMan == null) ? Padding(
        ...
        Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            RatingBar(
              rating: _takeAway ? track.store != null ? track.store!.avgRating : '' as double? : track.deliveryMan!.avgRating, size: 10,
              ratingCount: _takeAway ? track.store != null ? track.store!.ratingCount : '' as int? : track.deliveryMan!.ratingCount,
            ),
          ])),
          InkWell(
            onTap: () async {
